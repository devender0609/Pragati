    ...
    <section className="rounded-2xl bg-paper-200/70 p-5 sm:p-6">
      ...
      <div className="mt-4">
        ...
        <Row
          ...
          detail="Older Pragati activities that practise the same mathematics. Assignable now, and shown to the student as practice — never as the chapter's lesson."
        ...
        <Row
          ...
          tone="text-ink-500"
          detail="The formal, governed assessment track. It is not assigned from this screen, and an instructional check never becomes one: Growth carries calibration and norming claims that ordinary classroom practice cannot support."
          items={[]}
        />
      </div>
      {preparing.length > 0 && (
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
        <MetricCard label="Open now" value={String(activeCount)} />
        <MetricCard
          label="Closed"
          value={String(assignments.length - activeCount)}
        />
        <MetricCard label="All time" value={String(assignments.length)} />
      </div>
