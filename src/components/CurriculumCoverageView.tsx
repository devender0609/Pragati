...
function GradePill({
  ...
  return (
    <button
      onClick={onClick}
      // v0.54 §14 — 44px touch target; these were 28px.
      className={`inline-flex min-h-[44px] items-center rounded-full px-3 py-1 text-xs font-semibold ring-1 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 ${
        active
