 ...
 *
 * v0.70 adds `tap`, the utility introduced in v0.69 which applies
 * `min-h-[44px] min-w-[44px]`. This is a STATIC check on class names —
 * a proxy, not a measurement — and the real guarantee is the base-layer
 * 44px floor on every button plus the measured check in the screenshot
 * harness. It is kept because it fails fast, in the unit suite, before
 * anyone opens a browser.
 */
const TARGET_OK = /\btap\b|min-h-\[(4[4-9]|[5-9]\d)px\]|min-h-11|min-h-12|py-2\.5|py-3|btn-primary|btn-secondary/;
