...
export const suggestNextStep = (
  ...
  return {
    ...
    detail:
      'Every skill across the Class 6 Math modules is in the Strong band on this device (prototype signal — not a calibrated mastery claim). You can keep practising any skill or revisit the Learn pages for review.',
    perSkillSummary,
  };
};
