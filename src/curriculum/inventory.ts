...
export const STUDENT_STATUS_LABEL: Record<DerivedStatus, string> = {
  ...
  shell: 'Coming soon',
  // v0.56 §14 — "Practice available" alone read as though the chapter
  // were ready; a student opening it found questions but no lesson.
  // The label now says what is missing too.
  assessment_prototype: 'Practice only — lessons coming soon',
  lesson_prototype: 'Lessons only — practice coming soon',
