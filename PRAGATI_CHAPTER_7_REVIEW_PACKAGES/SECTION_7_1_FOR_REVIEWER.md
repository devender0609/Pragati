# Pragati review — Section 7.1

**Fractional Units and Equal Shares**

Review code: `S71-v1-0E86DC`
Source: https://ncert.nic.in/textbook/pdf/fegp1dd.zip, p. 151
Questions: 16
...
You are the first reviewer of this
...
**M1.** Is every mathematical statement in this section correct?

_Asked because: Every lesson is judged on this._

**M2.** Is the notation the one a Class 6 student meets in Ganita Prakash?

_Asked because: Every lesson is judged on this._

**M3.** Does the explanation match what this section of the printed book actually teaches?

_Asked because: Every lesson is judged on this._

**M4.** Would this explanation work with your own Class 6 students?
...
**O2.** Would you be willing to use this section with a class as it stands?
...
Send your answers back with the review code `S71-v1-0E86DC` quoted at the top.
